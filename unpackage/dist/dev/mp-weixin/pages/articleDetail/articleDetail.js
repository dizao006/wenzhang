...
if (!Array) {
  ...
  (_component_path + _component_svg + _easycom_uni_popup2 + _easycom_uv_parse2 + _easycom_uni_icons2 + _easycom_CommentMasker2)();
}
...
if (!Math) {
  (AiVue + _easycom_uni_popup + _easycom_uv_parse + commentBoxVue + _easycom_uni_icons + love + _easycom_CommentMasker)();
}
const love = () => "../../components/love/love.js";
const commentBoxVue = () => "../../components/comment-box/commentBox.js";
const AiVue = () => "../Ai/Ai2.js";
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const isShows = common_vendor.ref(false);
    function changeAi() {
      console.log("sss");
      if (isShows.value) {
        aiPopup.value.close();
    ...
    return (_ctx, _cache) => {
      ...
      return common_vendor.e({
        ...
        g: common_vendor.o(changeAi),
        h: common_vendor.sr(aiPopup, "c105ddd4-2", {
          "k": "aiPopup"
        }),
        i: common_vendor.p({
          type: "right"
        }),
        j: common_vendor.t((_a = Parms.value) == null ? void 0 : _a.title),
        k: (_b = Parms.value) == null ? void 0 : _b.author.avatar,
        l: common_vendor.t((_c = Parms.value) == null ? void 0 : _c.author.author_name),
        m: common_vendor.t((_d = Parms.value) == null ? void 0 : _d.create_time),
        n: common_vendor.t((_e = Parms.value) == null ? void 0 : _e.browse_count),
        o: common_vendor.t((_f = Parms.value) == null ? void 0 : _f.thumbs_up_count),
        p: common_vendor.t(isFllow.value ? "取消关注" : "关注"),
        q: common_vendor.o(followAuthor),
        r: common_vendor.p({
          content: content.value,
          selectable: true,
          lazyLoad: "true"
        }),
        s: common_vendor.f(commentList.value, (item, k0, i0) => {
          return {
        ...
        w: common_vendor.o(openShow),
        x: common_vendor.p({
          type: "chat",
          size: "22",
          color: "#f07373"
        }),
        y: common_vendor.o(goComment),
        z: common_vendor.p({
        ...
        B: common_vendor.o(setGoodOk),
        C: common_vendor.o(closeShow),
        D: common_vendor.o(sendDataComent),
        E: common_vendor.p({
          isshow: isShow.value
        })
      });
