<template>
  <view>
    ...
    <!-- 多图模式 -->
    <view
      v-if="props.list.mode === 'column'"
      @click="goArticleDetail"
      class="list-card model-column"
    >
      ...
      <view class="list-card-middle">
        <view
          ...
          v-for="(item, index) in props.list.cover.slice(0, 3)"
          :key="index"
        >
    ...
    <!-- 大图模式 -->
    <view
      v-if="props.list.mode === 'image'"
      @click="goArticleDetail"
      class="list-card model-image"
    >
      <view class="list-card-top">
